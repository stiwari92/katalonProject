...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Password_password'), username)
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/i_Timesheets_oxd-icon bi-caret-down-fill ox_af480c'))
